...
<html>
    ...
    <body>
        ...
        <form action="searchBookingServlet" method ="Post">
            ...
            <a href="searchVehicleServlet">Add Booking Now</a>
        </form>
        ...
        <table cellspacing="5" cellpadding="5" border="1">   
            ...
            <c:forEach var="booking" items="${listCrurrentBooking}">
                <tr valign="top">
                    <td>${booking.id}</td>
                    ...
                    <td><a href="checkinBookingServlet?booking_id=${booking.id}">Chọn</a></td>
                </tr>
            </c:forEach>
        </table>    
    </body>
